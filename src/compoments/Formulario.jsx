...
export const Formulario = ({setPacientes}) => {
  ...
  const handleSubmit = (e) => {
    ...
    if ([nombre, apellido, telefono, fecha, sintomas].includes('')) {
      ...
      setError(false)
      //setPacientes([nombre, apellido, telefono, fecha, sintomas])
      // Crear un objeto que representa al paciente
      const nuevoPaciente = {
        nombre,
        apellido,
        telefono,
      ...
      // Llamar a la función setPacientes para agregar el nuevo paciente al array
  ...
  return (
    <div className="w-full lg:w-3/4 p-4">
      <h2 className="text-2xl font-bold mb-4">Seguimientos de Pacientes</h2>
      ...
      {error  && <p className="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative" role="alert"> Todos los campos son obligatorios</p>}
        <div>
